    ...
    <div className="mb-6 animate-fadeIn">
      {loading ? (
        ...
        <div className="bg-[#18181b] p-6 rounded-xl border border-lol-hextech/30 text-sm text-gray-300 font-light leading-relaxed relative overflow-hidden shadow-2xl">
           ...
           <div className="relative z-10 prose prose-invert max-w-none prose-p:text-gray-300 prose-strong:text-white prose-li:text-gray-300" dangerouslySetInnerHTML={{ __html: analysis?.replace(/\n/g, '<br/>') || '' }} />
        </div>
      )}
    </div>
  );
