  ...
  return (
    <div className="max-w-[1600px] mx-auto px-4 py-8 grid grid-cols-1 lg:grid-cols-12 gap-6 h-auto min-h-[calc(100vh-80px)]">
      ...
      <div className="lg:col-span-3 space-y-8">
        ...
        {/* Runes Selector */}
        <div className="text-red-500 font-bold text-xl border border-red-500 p-4">DEBUG: RUNE SELECTOR AREA</div>
        <RuneSelector selectedRunes={selectedRunes} onChange={setSelectedRunes} lang={lang} />
