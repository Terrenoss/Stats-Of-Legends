            ...
            <div className="flex flex-col gap-8">
                ...
                <div className="flex flex-col xl:flex-row gap-8 border-b border-white/5 pb-8">
                    ...
                    <div className="flex-1">
                        ...
                        {startingItems && startingItems.length > 0 ? (
                            <div className="space-y-3">
                                {startingItems.map((group: any, idx: number) => {
                                    // Stack items logic
                                    ...
                                    <div className="flex items-center gap-4">
                                        {itemPaths[0].path.map((id: number, i: number) => (
                                            <div key={i} className="flex items-center gap-3">
                                                ...
                                                {i < itemPaths[0].path.length - 1 && <span className="text-gray-600 text-xl">→</span>}
                                            </div>
                                        ))}
                                    </div>
                                    <div className="text-right">
                                        <div className="text-green-400 font-bold text-2xl">{itemPaths[0].winRate.toFixed(2)}% WR</div>
                                        <div className="text-sm text-gray-500">{itemPaths[0].matches} Matches</div>
