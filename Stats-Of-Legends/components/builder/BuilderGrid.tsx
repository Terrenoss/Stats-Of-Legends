...
import { ChevronDown, Search, Plus, X, Undo, Redo, RotateCcw, Brain, Zap, Loader2 } from 'lucide-react';
import { Champion, Item } from '../../types';
import { MOCK_CHAMPIONS, BUILDER_ITEMS } from '../../constants';
...
export const BuilderGrid: React.FC<BuilderGridProps> = ({ 
  selectedItems, setSelectedItems, currentChampion, setCurrentChampion, 
            ...
            <div className="bg-[#121212] border border-lol-gold/20 p-6 rounded-[2rem] shadow-xl animate-fadeIn flex items-center gap-5 relative overflow-hidden">
                 ...
                 <div className="relative z-10">
                    ...
                    <div className="flex items-center gap-2 text-xs text-gray-500 mt-1">
                        ...
                        <span>Gemini 3 Pro is evaluating item synergy & meta viability...</span>
                    </div>
                 </div>
            </div>
        )}
