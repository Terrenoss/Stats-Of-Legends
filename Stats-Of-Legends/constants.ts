...
// ... (Rest of imports remain, skipping to generateParticipants update)
...
// ... (MOCK_PROFILE, MOCK_TEAMMATES, etc. remain the same)
...
// ... (Timeline and Build Path generators remain)
