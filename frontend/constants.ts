import { GameMode, Match, SummonerProfile, Item, Champion, DummyStats, Language, Region, HeatmapDay, LPPoint, DetailedChampionStats, RoleStat, Participant, Teammate, MatchTimelinePoint, ItemTimestamp } from './types';

export const CURRENT_PATCH_FALLBACK = "15.23.1";

export interface SeasonInfo {
  season: string; // e.g. "Season 2025"
  split: string;  // e.g. "Split 1"
}

// valeur par défaut si pas encore déterminé côté client/serveur
export const DEFAULT_SEASON_INFO: SeasonInfo = {
  season: 'Season 2024',
  split: 'Split 2',
};
...
export const RANK_EMBLEMS: Record<string, string> = {
  "IRON": "https://raw.communitydragon.org/latest/plugins/rcp-fe-lol-shared-components/global/default/images/tier-icons/tier-iron.png",
  "BRONZE": "https://raw.communitydragon.org/latest/plugins/rcp-fe-lol-shared-components/global/default/images/tier-icons/tier-bronze.png",
  "SILVER": "https://raw.communitydragon.org/latest/plugins/rcp-fe-lol-shared-components/global/default/images/tier-icons/tier-silver.png",
  "GOLD": "https://raw.communitydragon.org/latest/plugins/rcp-fe-lol-shared-components/global/default/images/tier-icons/tier-gold.png",
  "PLATINUM": "https://raw.communitydragon.org/latest/plugins/rcp-fe-lol-shared-components/global/default/images/tier-icons/tier-platinum.png",
  "EMERALD": "https://raw.communitydragon.org/latest/plugins/rcp-fe-lol-shared-components/global/default/images/tier-icons/tier-emerald.png",
  "DIAMOND": "https://raw.communitydragon.org/latest/plugins/rcp-fe-lol-shared-components/global/default/images/tier-icons/tier-diamond.png",
  "MASTER": "https://raw.communitydragon.org/latest/plugins/rcp-fe-lol-shared-components/global/default/images/tier-icons/tier-master.png",
  "GRANDMASTER": "https://raw.communitydragon.org/latest/plugins/rcp-fe-lol-shared-components/global/default/images/tier-icons/tier-grandmaster.png",
  "CHALLENGER": "https://raw.communitydragon.org/latest/plugins/rcp-fe-lol-shared-components/global/default/images/tier-icons/tier-challenger.png"
};
...
export const TRANSLATIONS: Record<Language, Record<string, string>> = {
  ...
  ES: {
    ...
    heroTitle: "Domina tu",
    heroHighlight: "Juego",
    heroDesc: "Estadísticas detalladas, análisis de IA y seguimiento de progreso.",
...
// Builder Items (Existing data kept)
...
const generateParticipants = (myChampId: number, isWin: boolean): Participant[] => {
    ...
    list.push({
        ...
        spells: [],
        visionScore: 35,
        totalDamageDealtToChampions: isWin ? 32000 : 21000,
    ...
    for (let i = 0; i < 4; i++) {
        list.push({
            ...
            totalDamageDealtToChampions: Math.floor(Math.random() * 25000) + 5000,
...
// Generate Timeline Data for a match
